...
const Home = () => {
	...
	function getShadowToRed () {
		...
		if (colorRed == "4px 4px 20px rgba(255, 255, 255, 1)") {
			setColorRed("none")
		} else {
			setColorRed("4px 4px 20px rgba(255, 255, 255, 1)")
			setColorOrange("none")
			setColorGreen("none")
		}
	}
	...
	function getShadowToOrange () {
		...
		if (colorOrange == "4px 4px 20px rgba(255, 255, 255, 1)") {
			setColorOrange("none")
		} else {
			setColorOrange("4px 4px 20px rgba(255, 255, 255, 1)")
			setColorRed("none")
			setColorGreen("none")
		}
	}
	...
	function getShadowToGreen () {
		...
		if (colorGreen == "4px 4px 20px rgba(255, 255, 255, 1)") {
			setColorGreen("none")
		} else {
			setColorGreen("4px 4px 20px rgba(255, 255, 255, 1)")
			setColorOrange("none")
			setColorRed("none")
		}
	}
